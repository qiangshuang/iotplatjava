...
public class VisitpersonServiceImpl implements VisitpersonService {
    ...
    public Visitperson queryById(Long id){
        return this.visitpersonDao.queryById(id); 
    } 
    ...
    public JSONObject addInst( JSONObject jsonObj){
            ...
            jsonObj = ParaUtils.removeSurplusCol(jsonObj,"id,idno,name,gender,image,phonenumber");
            this.visitpersonDao.addInst(jsonObj);
