...
public class JobServiceImpl implements JobService {
    ...
    public JSONObject addInst( JSONObject jsonObj){
            ...
            jsonObj = ParaUtils.removeSurplusCol(jsonObj,"title,sort,memo,id");
            this.jobDao.addInst(jsonObj);
    ...
    public void updateInst(JSONObject jsonObj){
        jsonObj = ParaUtils.removeSurplusCol(jsonObj,"title,sort,memo,id");        this.jobDao.updateInst(jsonObj); 
    } 
    //@param jsonObj 调用参数 
    //@return 影响记录数%s 
    @Override 
