...
public class DataflowServiceImpl implements DataflowService {
    ...
    public JSONObject addInst( JSONObject jsonObj){
            ...
            this.dataflowDao.addInst(jsonObj);
    ...
    public void updateInst(JSONObject jsonObj){
        jsonObj = ParaUtils.removeSurplusCol(jsonObj,"id,dataval,datatitle,company,comsym,equman");        this.dataflowDao.updateInst(jsonObj); 
    } 
}
