...
public class JWTFilter extends BasicHttpAuthenticationFilter{
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        if ( "/".equals(servletPath) || servletPath.startsWith("/captcha")  || servletPath.startsWith("/login") ||servletPath.startsWith("/logout") ||
           servletPath.startsWith("/static") || servletPath.startsWith("/401") || 
